<template>
  <div class="relative mx-auto max-w-1620 my-[5rem]">
    <SfScrollable
    ...
    >
      <template #previousButton="defaultProps">
        <SfButton
          ...
          class="absolute hidden group-hover/scrollable:block disabled:!hidden !rounded-full !p-3 z-10 top-1/2 right-3 bg-white"
          variant="secondary"
          size="lg"
          square
        >
      ...
      >
        <img
          class="object-cover w-[770px] h-[708px]"
          :aria-label="alt"
